...
from utils import update_model, save_simple_metrics_report, get_model_preformance_test_set
import logging
import sys
import numpy as np
import pandas as pd
...
#Actualizacion del modelo. La funcion que guardara el mejor modelo está en utils.py
...
get_model_preformance_test_set(y_test, y_test_pred)
